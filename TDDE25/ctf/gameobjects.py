...
class Tank(GamePhysicsObject):
    ...
    def __init__(self, x, y, orientation, sprite, space):
        ...
        self.cooldown             = 50                        # Variable used to determine if a tank is allowed to shoot or not
        self.base_hp              = 6
        self.hp                   = self.base_hp                        # Hitpoints of the tank
        self.score                = 0                         # Score of tank
    ...
    def shoot(self, space):
        ...
        bullet = Bullet(self.body.position[0], self.body.position[1], self, images.bullet, space, True)
        sound.shoot_sound.set_volume(0.05)
...
class Bullet(GamePhysicsObject):
    ...
    def __init__(self, x, y, tank, sprite, space, movable):
        self.orientation = tank.body.angle
        self.tank = tank

        super().__init__( x, y, self.orientation, sprite, space, movable)
    ...
    def update(self):
        self.body.position += pymunk.Vec2d(0, self.SPEED).rotated(self.orientation)
