...
class PC_Game(VideoGame):
    ...
    def print_description(self):
        super(VideoGame, self).print_description()
        print(f'Developed by {self.developer} for {self.platform} requirements {self.requirements}')


products = [
    Book('Harry Potter 1', 20, 'J.K. Rowling'),
    VideoGame('Call of Duty 42', 200, 'Treyarch', 'PC'),
    PC_Game('BTD 7', 1738, 'Ninjakiwi', 'PC', 'RTX 5090')
]
