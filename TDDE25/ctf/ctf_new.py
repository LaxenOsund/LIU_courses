...
#-- Creates ai tanks
def create_ai_tanks(current_map, tanks_list, game_objects_list, ai_list):
...
def fog_of_war(FOG_OF_WAR, tanks_list, screen):
    if FOG_OF_WAR:
...
def play_game():
    ...
    while running:
        ...
        fog_of_war(FOG_OF_WAR, tanks_list, screen)
